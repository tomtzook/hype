...
public:
    ...
    type_t vmread(vmcs_field_t field) noexcept {
        return reinterpret_cast<type_t>(vmread(field));
    }
    template<typename type_t>
    void vmwrite(vmcs_field_t field, type_t value) noexcept {
        vmwrite(field, reinterpret_cast<uintn_t>(value));
    }
